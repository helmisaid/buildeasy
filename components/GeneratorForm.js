  ...
  const handleFeatureChange = (e) => {
    ...
    setFormData(prev => {
        ...
        const featureTriggers = {
            [availableFeatures.productList?.name]: { key: 'products', item: {id: Date.now(), name: '', price: '', oldPrice: '', fileObject: null, previewUrl: null} },
            [availableFeatures.projectGallery?.name]: { key: 'portfolioProjects', item: {id: Date.now(), name: '', description: '', fileObject: null, previewUrl: null, projectUrl: ''} },
            [availableFeatures.testimonials?.name]: { key: 'testimonials', item: {id: Date.now(), name: '', text: '', fileObject: null, previewUrl: null} },
            [availableFeatures.ourTeam?.name]: { key: 'teamMembers', item: {id: Date.now(), name: '', role: '', fileObject: null, previewUrl: null} },
            [availableFeatures.services?.name]: { key: 'services', item: {id: Date.now(), name: '', description: ''} },
            [availableFeatures.faq?.name]: { key: 'faqs', item: {id: Date.now(), question: '', answer: ''} }
        };
