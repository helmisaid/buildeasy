// File: lib/content.js
// Description: Contains all multilingual text, updated with new labels for conditional inputs.
...
const content = {
    id: {
        ...
        aboutComponentTextLabel: 'Teks Deskripsi "Tentang Kami"',
        aboutComponentHint: 'Jika kosong, deskripsi singkat brand akan digunakan.',
        contactComponentFeaturesLabel: 'Fitur Tambahan Formulir Kontak',
        addPhoneField: 'Tambahkan kolom Nomor Telepon',
        addSubjectField: 'Tambahkan kolom Subjek',
    ...
    en: {
        ...
        aboutComponentTextLabel: '"About Us" Description Text',
        aboutComponentHint: 'If left blank, the main brand description will be used.',
        contactComponentFeaturesLabel: 'Contact Form Additional Features',
        addPhoneField: 'Add Phone Number field',
        addSubjectField: 'Add Subject field',
